...
<form method = "post" action="">
   ...
   <div style="text-align:center"> 
        ...
        <p>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<input type="text" style="text-align:center;color: #FF0000; font-size: medium;" name="Ampro_barcode1" value="<?php echo "";?>"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        <input type="text" style="text-align:center;color: #FF0000; font-size: large;" name="SMC_barcode1" value="<?php echo "";?>">

        &nbsp &nbsp &nbsp<input type="submit" name="submit8" style="text-align:center;color: #FF0000; font-size: large;" value="Input Barcode"> </p>
        </ul>
    </div>
...
if (isset($_POST['submit8'])) {
    ...
    $sql = "INSERT INTO `PCB_Barcode`(`Ampro_barcode`, `SMC_Barcode`, `operator`) VALUES('$Ampro_barcdoe1','$SMC_barcdoe1', '$operator')";
